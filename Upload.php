...
<body>
    <?php 
    include "layout/header_adminU.html";
    ?>

<main class="flex-shrink-0">
  <div class="container">
    <h2 class="mt-2 text-white">Upload Moment Aesthetic Mu <?= $_SESSION['namalengkap'] ?> </h2>
    <hr>
      ...
      <div class="col-sm-3">
        ...
        <form action="Upload.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-2">
            ...
            <textarea name="deskripsifoto" id="deskripsifoto" class="form-control" rows="3" placeholder="enter deskripsi foto"></textarea>
          </div>
          <div class="mb-2">
          ...
          <button type="submit" class="btn btn-primary mb-3 mt-1" name="tambah">Tambah Foto</button>
        </form>
      </div>
      <div class="col-sm-9">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="Upload.php?fotoid=<?= $data['fotoid'] ?>" onclick="return confirm('Yakin menghapus data?')"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
                  <a href="edit_Upload.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-dark btn-sm">Edit</button></a>
                </td>
              </tr>
            <?php
            }
