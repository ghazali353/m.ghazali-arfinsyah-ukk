...
<?php
    include "layout/header_adminA.html";
    ?>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="album.php?albumid=<?= $data['albumid'] ?>" onclick="return confirm('Yakin menghapus data?')"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
                    <a href="album_edit.php?albumid=<?= $data['albumid'] ?>"><button type="button" class="btn btn-dark btn-sm">Edit</button></a>
                  </td>
                </tr>
              <?php
              }
