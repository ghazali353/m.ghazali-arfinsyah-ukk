...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-sm-6">
        <img src="gambar/<?= $lokasi ?>" alt="foto" class="img-thumbnail" height="100   px">
      </div>
      <div class="col-sm-4">
          ...
          <div class="card-body">
            <p> <strong><?= $userid2 ?> <?= $usernama2 ?> :</strong> <i>
                <form action="komentar.php" method="post">
                  ...
                  <input type="text" name="isikomentar" id="isikomentar"required> 
                  <input type="submit" value="komentar" name="komentar" class="btn btn-outline-primary btn-sm">
                </form>
              </i> </p>
          </div>
        </div>
