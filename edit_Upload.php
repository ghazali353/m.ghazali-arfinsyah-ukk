...
<main class="flex-shrink-0">
  <div class="container">
    <h2 class="mt-2">Ada Yang Mau Diubah <?= $_SESSION['namalengkap'] ?> </h2>
    <hr>
      ...
      <div class="col-sm-3">
        ...
        <form action="edit_Upload.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <textarea name="deskripsifoto" id="deskripsifoto" class="form-control" rows="2" placeholder="enter deskripsi foto"><?= $deskripsi2 ?></textarea>
          </div>
          <div class="mb-3">
          ...
          <button type="submit" class="btn btn-primary mb-3 mt-1" name="update">Update</button>
        </form>
      </div>
      <div class="col-sm-9">
