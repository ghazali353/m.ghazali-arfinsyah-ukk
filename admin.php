...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-2 text-center">Welcome <?= $_SESSION['namalengkap'] ?> </h1>
    ...
    <div class="row justify-content-center">
      ...
      ?>
        <div class="col-sm-3 my-1 text-center mb-4 mt-4">
          <div class="card">
            ...
            <div class="card-footer">
              ...
              ?>
              <a href="admin.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-danger btn-sm">like (<?= mysqli_num_rows($sql2) ?>)</button></a>
              <a href="komentar.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-light btn-sm">Komentar (<?= mysqli_num_rows($sql3) ?>)</button></a>
            </div>
          </div>
        </div>
      <?php
